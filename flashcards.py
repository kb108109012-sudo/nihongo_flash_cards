...
N5Lesson16 = st.Page(
    page="lessons/N5lesson16.py",
    title="Lesson 16",
    icon=":material/book:"
)
N5Lesson17 = st.Page(
    page="lessons/N5lesson17.py",
    title="Lesson 17",
    icon=":material/book:"
)
N5Lesson18 = st.Page(
    page="lessons/N5lesson18.py",
    title="Lesson 18",
    icon=":material/book:"
)

N5Lesson19 = st.Page(
    page="lessons/N5lesson19.py",
    title="Lesson 19",
    icon=":material/book:"
)

N5Lesson20 = st.Page(
    page="lessons/N5lesson20.py",
    title="Lesson 20",
    icon=":material/book:"
)
...
pg = st.navigation(
    {
        ...
        "N5" : [N5Lesson1, N5Lesson2, N5Lesson3, N5Lesson4, 
                ...
                N5Lesson13, N5Lesson14, N5Lesson15, N5Lesson16,
                N5Lesson17, N5Lesson18, N5Lesson19, N5Lesson20],
    }
)
